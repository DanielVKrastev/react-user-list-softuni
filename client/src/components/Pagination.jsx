    ...
    return(
      ...
      <div className="pagination position">
        <div className="limits">
          ...
          <select name="limit" className="limit" defaultValue="5" onClick={onSetItemsPerPage}>
        ...
        <p className="pages">1 - {pages} of {currentPage}</p>
        <div className="actions">
          <button className="btn" title="First Page" onClick={() => onChangePage(1)} disabled={currentPage === 1}>
          ...
          <button className="btn" title="Previous Page" onClick={() => onChangePage(currentPage - 1)} disabled={currentPage === 1}>
          ...
          <button className="btn" title="Next Page"  onClick={() => onChangePage(currentPage + 1)} disabled={currentPage === pages}>
          ...
          <button className="btn" title="Last Page" onClick={() => onChangePage(pages)} disabled={currentPage === pages}>
